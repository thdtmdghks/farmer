export function Resume1Details() {
  return (
    <>
      ...
      <section>
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-700 italic">
            결제 서비스 개발팀 풀스택 개발자. 백오피스 모노레포 아키텍처 구축 및
            블록체인 지갑 도메인 개발 전담
          </p>
          ...
          <div className="mt-4 rounded-lg border border-gray-200 p-5">
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  Turborepo 기반 모노레포 아키텍처 설계 및 구축 ➔ 공유 패키지
                  분리를 통한 멀티 앱 구조 설계 및 개발 생산성 개선
                </li>
                <li>
                  ESLint 정적 분석 규칙 설정을 통한 단방향 의존성 흐름 강제 및
                  CI/CD 연계 ➔ 레이어 간 순환 참조 차단 및 아키텍처 무결성 확보
                </li>
                <li>
                  API 명세 확정 단계에서 백엔드팀과 요청/응답 스키마 선제 조율 ➔
                  명세 합의 완료 후 병목 없는 개발 프로세스 확립
                </li>
                <li>
                  MSW 기반 독립 Mock 개발 환경 설계 및 구축 ➔ 백엔드 API 미완성
                  상태에서 피처 개발 및 모바일 QA 병행 환경 확보
                </li>
                <li>
                  Vitest 및 React Testing Library 기반 유닛 테스트 환경 구축 ➔
                  인증 컴포넌트, 전역 스토어, 공통 유틸의 코드 안정성 확보
                </li>
                <li>
                  Zod 활용 런타임 환경변수 검증 및 폼 유효성 검사 구조 통합 ➔
                  런타임 에러 방지 및 데이터 신뢰성 강화
                </li>
                <li>
                  node-forge를 활용한 RSA-OAEP 클라이언트 비밀번호 암호화 로직
                  구현 ➔ 공개키 싱글턴 캐싱 및 만료 감지 시 캐시 무효화와 재발급
                  흐름 구축
                </li>
                <li>
                  shadcn/ui 기반 공유 디자인 시스템 패키지 구축 및 웹 접근성
                  표준 준수 ➔ 스크린 리더/키보드 내비게이션 대응으로 사용성 개선
                </li>
                <li>
                  공유 패키지 수정 시 즉각적인 HMR 반영 설정 ➔ 빌드 없는 실시간
                  화면 갱신으로 개발 피드백 루프 최소화
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  ...
                  Swagger 문서화 ➔ 지갑 도메인 개발 전담
                </li>
                <li>
                  EVM 계열 코인/ERC-20 토큰의 트랜잭션 전송 및 영수증 폴링 모듈
                  개발 ➔ 온체인 전송 프로세스 안정화
                </li>
                <li>
                  nock 및 DB 격리(TRUNCATE)를 적용한 E2E 테스트 파이프라인 구축
                  ➔ 외부 API/테스트넷 지연에 흔들리지 않는 결정론적 테스트 환경
                  확보
                </li>
                <li>
                  Docker Compose를 활용한 로컬 개발 환경(DB, MPC 노드) 구축 ➔
                  개발자 환경 세팅 시간 단축 및 로컬 검증 편의성 개선
                </li>
                <li>
                  주요 아키텍처 결정 사항에 대한 ADR 수립 및 문서화 ➔ 기술 도입
                  및 설계 히스토리 투명화
                </li>
                <li>
                  외부 API 호출 제한을 고려한 온체인 트랜잭션 상태 폴링 스케줄링
                  및 예외 처리 구현 ➔ 트랜잭션 추적 및 누수 방지
                </li>
              </ul>
            </div>
          ...
          <div className="mt-4 rounded-lg border border-gray-200 p-5">
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  Sandbox 결제 환경에서 요청, 승인, 콜백 과정 통합 검증 ➔
                  프로덕션 연동 장애 요인 사전 차단
                </li>
              </ul>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 rounded-lg border border-gray-200 p-5">
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  신규 PG 결제 서비스 초기 기획 참여, MVP 개발 및 프로덕션 출시
                  ➔ 신규 결제 서비스 성공적 시장 진입에 기여
                </li>
                <li>
                  Pinia 스토어 내에 다단계 결제 및 가입 비즈니스 로직과 유효성
                  검증 단계 캡슐화 ➔ UI 컴포넌트와 상태 제어 로직의 결합도 제거
                </li>
                <li>
                  Playwright E2E 자동 테스트 구축 및 CI/CD 연계 ➔ 결제 시나리오
                  자동 검증 및 결함 코드의 배포 원천 차단
                </li>
                <li>
                  백엔드팀과 API 요청/응답 스키마 선제 합의 및 JSON Server Mock
                  구축 ➔ 백엔드 API 완성 전 피처 개발 및 화면 병행 개발 환경
                  확보
                </li>
                <li>
                  pnpm workspace 기반 모노레포 구축으로 공통 UI 컴포넌트/유틸
                  독립 패키지화 ➔ 서비스 간 중복 코드 비대화 해소 및 의존성 꼬임
                  방지
                </li>
                <li>
                  Figma 내 시안 리뷰용/구현 예정용 버저닝 관리 체계 도입 ➔
                  기획-디자인-개발 간 소통 혼선 제거
                </li>
                <li>
                  AWS S3 이메일 템플릿 배포 자동 버저닝 및 롤백 스크립트 구축 ➔
                  마케팅 메일 배포 안정성 확보
                </li>
                <li>
                  슬랙 워크플로우를 활용한 데일리 업무 알림 프로세스 자동화 ➔
                  반복 업무 수동 공수 제거
                </li>
                <li>
                  Git PR 및 이슈 템플릿 표준화 도입 ➔ 개발팀 내 협업 가이드라인
                  확립 및 리뷰 프로세스 효율화
                </li>
              </ul>
            </div>
          ...
          <div className="mt-4 rounded-lg border border-gray-200 p-5">
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  Next.js SSR 데모 결제 서비스의 화면 및 API Route 설계/개발 ➔
                  영업 시연용 데모 결제 서비스 구축에 기여
                </li>
                <li>
                  Jest 기반 핵심 데이터 연산 모듈 단위 테스트 적용 ➔ 결제 계산
                  오동작 방지
                </li>
                <li>
                  MSW 도입을 통한 배포 환경 내 Mock 동작 구현 ➔ 모바일 및 외부
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  ...
                  단독 개발/배포 ➔ 가입 프로세스 병목 해소 및 장애 0건 무장애
                  운영 달성
                </li>
                <li>
                  레이어드 아키텍처 도입 및 모듈화 ➔ 코드의 역할과 책임을
          ...
          <div className="mt-4 rounded-lg border border-gray-200 p-5">
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  레거시 어드민의 Next.js 기반 리뉴얼 및 분할 패널 UI 도입 ➔
                  정산 처리 및 상세 데이터 검토 동선 개선
                </li>
                <li>
                  달력 UI 기반 자동 계산 수수료 대조 연산 적용 ➔ 수동 계산 공수
                  제거 및 정산 작업 속도 개선
                </li>
                <li>
                  유닛 테스트 기반 정산 연산 무결성 검증 로직 구축 ➔ 정산액 계산
                  오류 사전 차단
                </li>
              </ul>
            </div>
        ...
        <div>
          ...
          <div className="mt-4 rounded-lg border border-gray-200 p-5">
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  웹 영상 편집기 타임라인 UI 및 데이터 아키텍처 설계 ➔ 편집기
                  프레임워크 기초 설계
                </li>
                <li>
                  클립 드래그 앤 드롭, 스냅 바인딩 등 핵심 인터랙션 구현 ➔
                  타임라인 기본 편집 사용성 확보
                </li>
                <li>
                  Canvas API와 HTML DOM 하이브리드 렌더링 도입 ➔ 대량의 미디어
                  클립 조작 시 발생하는 브라우저 프레임 하락 현상 극복
                </li>
                <li>
                  로그 함수 기반 타임라인 줌 배율 구현 ➔ 사용자 체감 줌 곡선
          ...
          <div className="mt-4 rounded-lg border border-gray-200 p-5">
            ...
            <div className="mt-3 pl-3">
              ...
              <ul className="mt-2 list-disc space-y-1.5 pl-8 text-sm text-gray-700">
                <li>
                  지상파 방송사 보도 레거시 시스템 유지보수 및 신규 피처 개발 ➔
                  라이브 시스템 안정 운영
                </li>
                <li>
                  배포 환경 빌드 버전 표준화 ➔ Node.js 버전 불일치로 인한 빌드
                  오동작 해결 및 최종 배포 준수 (2주 조기 배포)
                </li>
              </ul>
            </div>
          </div>
